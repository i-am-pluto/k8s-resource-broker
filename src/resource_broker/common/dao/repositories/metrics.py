...
class MetricsRepository:
    ...
    async def get_percentiles(
        ...
        stmt = select(
            ...
            func.percentile_cont(0.99).within_group(PodMetricModel.cpu_usage_cores).label("cpu_p99"),
            ...
            func.percentile_cont(0.99).within_group(PodMetricModel.mem_usage_bytes).label("mem_p99"),
        ).where(
